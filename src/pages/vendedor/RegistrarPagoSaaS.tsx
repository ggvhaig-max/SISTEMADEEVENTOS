  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold text-white">Registrar Venta SaaS</h1>
      </div>

      <form onSubmit={handleSubmit} className="bg-gray-800 p-6 rounded-xl border border-gray-700 space-y-6">
        <div>
          <label className="block text-sm font-medium text-gray-400 mb-2">Cliente / Negocio</label>
          <select 
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">Tipo de Venta</label>
            <select 
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">Plan Vendido</label>
            <select 
              className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white"
              value={formData.plan}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">Monto Cobrado ($)</label>
            <input 
              type="number"
              min="0"
              step="0.01"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-400 mb-2">Días a Activar</label>
            <select 
              className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white"
