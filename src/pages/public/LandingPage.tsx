...
export function LandingPage() {
  return (
    <div className="min-h-screen bg-gray-900 text-white font-outfit selection:bg-blue-500/30">
      {/* Navbar Minimalista */}
      <nav className="fixed top-0 left-0 right-0 p-6 z-50 flex items-center justify-between bg-gray-900/80 backdrop-blur-md border-b border-gray-800">
        <div className="flex items-center gap-2">
          <Ticket className="w-8 h-8 text-blue-500" />
          <span className="font-extrabold text-xl tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-500">
            SISTEMA DE EVENTOS
          </span>
        </div>
        <div className="flex items-center gap-4">
          ...
          <Link to="/register" className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2 rounded-lg font-medium transition-all shadow-lg shadow-blue-500/25">
            Crear cuenta
          </Link>
        </div>
      </nav>
      ...
      <header className="relative pt-40 pb-20 px-6 max-w-7xl mx-auto flex flex-col items-center justify-center text-center">
        <div className="absolute inset-0 flex items-center justify-center -z-10 overflow-hidden">
           <div className="w-[600px] h-[600px] bg-blue-600/20 rounded-full blur-[120px] absolute opacity-50"></div>
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          <Link to="/register" className="flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-xl shadow-blue-600/20 hover:scale-105">
            Empezar ahora <ArrowRight className="w-5 h-5" />
          </Link>
          <Link to="/login" className="flex items-center justify-center bg-gray-800 hover:bg-gray-700 text-white border border-gray-700 px-8 py-4 rounded-xl font-bold text-lg transition-colors">
            Ya tengo cuenta
          </Link>
        </div>
      </header>
      ...
      <section className="py-24 px-6 bg-gray-800/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg">Todo lo que necesitas centralizado en un solo lugar.</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-blue-500/50 transition-colors">
            ...
            <div className="bg-gray-800 rounded-2xl p-8 border border-gray-700 hover:border-purple-500/50 transition-colors">
      ...
      <section className="py-24 px-6 border-t border-gray-800">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1">
            <div className="inline-flex items-center gap-2 bg-indigo-500/10 text-indigo-400 px-3 py-1 rounded-full text-sm font-medium mb-6">
          ...
          <div className="flex-1 w-full bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-2xl p-8 relative overflow-hidden shadow-2xl">
             <div className="absolute -top-10 -right-10 w-40 h-40 bg-blue-500/20 rounded-full blur-3xl"></div>
             <div className="space-y-4 relative z-10">
               <div className="h-4 bg-gray-700/50 rounded-full w-1/3 mb-8"></div>
               {[...Array(4)].map((_, i) => (
                 <div key={i} className="flex items-center gap-4">
                   <div className="w-10 h-10 rounded-lg bg-gray-700/30"></div>
                   <div className="flex-1">
                     <div className="h-3 bg-gray-700/50 rounded-full w-full mb-2"></div>
                     <div className="h-2 bg-gray-700/30 rounded-full w-2/3"></div>
                   </div>
                   <div className="w-16 h-6 rounded-full bg-blue-500/20 border border-blue-500/30"></div>
                 </div>
               ))}
             </div>
          </div>
      ...
      {/* Footer CTA */}
      <footer className="py-16 px-6 bg-gray-900 border-t border-gray-800 text-center">
